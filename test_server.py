...
class TestBaseWhaleServer(unittest.TestCase):
    def setUp(self):
    ...
    def test_root_endpoint(self):
        ...
        data = resp.json()
        self.assertEqual(data["service"], "BaseWhale Oracle")
    ...
    def test_whales_requires_402_without_payment(self):
        resp = self.client.get("/v1/whales?min_usd=50000")
    ...
    def test_stats_requires_402_without_payment(self):
        resp = self.client.get("/v1/whale-stats")
        self.assertEqual(resp.status_code, 402)
        self.assertIn("Payment-Required", resp.headers)
